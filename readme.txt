...
Youtuber has been translated to french by the __[InMotion Hosting Team](http://www.inmotionhosting.com/)__. Thanks for your time guys!
...
* Version 1.8.2: Solving bug with high quality option.
* Version 1.8.1: Allowing fullscreen with iframe. 
* Version 1.8: Added possibility to autoscale video.
* Version 1.7: Added new Shortcode
* Version 1.6: Solved problem with the excerpt. Checked for WP 3.1
* Version 1.5.11: Modified TinyMCE call to solve bugs with wp-cache.
* Version 1.5.10: Solved bug with feeds when displaying Youtube videos.
